...
| 0026 | [Oura reaches Ignia through the OS health store, and its energy stops at the seed](0026-oura-through-the-os-health-store.md) | accepted, **amended 2026-08-24** — the workout read moves the Android fingerprint (measured) and not the iOS one, so it ships in two phases; the ten-user-cap argument against the Cloud API is withdrawn |
