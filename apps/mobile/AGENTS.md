...
Both channels are OPEN on those hashes; the newest OTA on each is `287a80db`
(2026-09-15, second publish). **Only a value read from the artifact is evidence** — a build
