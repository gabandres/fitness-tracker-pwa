...
Both channels are OPEN on those hashes; the newest OTA on each is `dae6aa3a`
(2026-09-16, second publish — ADR-0040 slice 3, the `hit` reader). **Only a value read from the artifact is evidence** — a build
