...
// Mirrors src/app/models/workout-seed.ts.
//
// LOCALIZATION: the English content above is the source; es-PR strings live in
...
// parity with src/app/models/workout-seed.ts.
