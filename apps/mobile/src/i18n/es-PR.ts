...
export const esPR: Record<I18nKey, string> = {
  ...
  'settings.inviteBody': 'Comparte Macro Log. Cuando un amigo se registra con tu enlace, ambos reciben un mes de Pro gratis.',
  'settings.inviteShare': 'Compartir enlace',
  'settings.inviteShareMsg': 'Cuenta calorías y proteína gratis con Macro Log:',
  'settings.inviteRewardActive': 'Recompensa Pro activa hasta {date}',
  'settings.support': 'Apoya la app',
  'settings.supportBody': 'Macro Log es gratis para registrar a mano. Si los escaneos de comida con IA te han servido, una pequeña propina ayuda a cubrir el costo — totalmente opcional y no desbloquea nada.',
