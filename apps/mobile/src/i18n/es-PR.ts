...
export const esPR: Record<I18nKey, string> = {
  ...
  'whatsNew.body':
    "Train ya entiende un estiramiento. Escoge Movilidad al añadir un ejercicio y se registra en segundos, va a cualquier extremo de una plantilla, y nunca cuenta para un récord ni una progresión — así una posición de calentamiento no se convierte en una marca personal. Hay una rutina de Reinicio de Movilidad en las plantillas iniciales, y si programas una posición larga antes de levantar, Ignia te dice lo que encontró la investigación y deja tu número tal cual. Escribir o dictar una comida también entiende bien las medidas ahora: una cucharadita de miel son siete gramos y no cien, 250 ml de leche son un vaso y no veinticinco kilos, funciona con alimentos en español y portugués, y una taza de arroz significa arroz cocido, no crudo.",
