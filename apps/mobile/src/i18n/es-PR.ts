...
export const esPR: Record<I18nKey, string> = {
  ...
  'train.invalidRirFailure': 'La activación llegó al fallo — sin cambio de carga.',
  ...
  'train.rec.reason.inBand': '{reps} reps @ RIR {rir} con {load}.',
  'train.rec.reason.inBandNoRir': '{reps} reps con {load}.',
  'train.rec.reason.bodyweightAdd': '{reps} reps a peso corporal — añade un disco o una banda.',
  'train.rec.reason.overBand': '{reps} reps — por encima del rango {lo}-{hi}, falta carga.',
  'train.rec.reason.belowBand': '{reps} reps la sesión pasada; el rango es {lo}-{hi}.',
  'train.rec.reason.belowBandCluster': 'C{group} dio {reps} reps la sesión pasada; ambos clústeres deben llegar a {lo}-{hi}.',
  ...
  'train.rec.invalid.rirToFailure': 'Activación a RIR 0 — llegó al fallo.',
