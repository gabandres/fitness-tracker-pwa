...
export const esPR: Record<I18nKey, string> = {
  ...
  'onboarding.titleNew': 'Bienvenido a Macronaut',
  ...
  'settings.inviteBody': 'Comparte Macronaut. Cuando un amigo se registra con tu enlace, ambos reciben un mes de Pro gratis.',
  'settings.inviteShare': 'Compartir enlace',
  'settings.inviteShareMsg': 'Cuenta calorías y proteína gratis con Macronaut:',
  'settings.inviteRewardActive': 'Recompensa Pro activa hasta {date}',
  'settings.support': 'Apoya la app',
  'settings.supportBody': 'Macronaut es gratis para registrar a mano. Si los escaneos de comida con IA te han servido, una pequeña propina ayuda a cubrir el costo — totalmente opcional y no desbloquea nada.',
  ...
  'pro.badge': 'Pro',
  'pro.upsellSub': 'Desbloquea esto y más con una compra única de Macronaut Pro.',
  'pro.learnMore': 'Ver qué incluye Pro',
  'pro.advancedTrends': 'Análisis y presupuesto semanal',
  'pro.title': 'Macronaut Pro',
