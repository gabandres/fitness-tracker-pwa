...
export const en = {
  ...
  'train.rec.action.calibrate': 'CALIBRATE',
  'train.rec.reason.noHistory': 'No session logged yet — the first one is a calibration, not a read.',
  'train.rec.reason.inBand': '{reps} reps @ RIR {rir} at {load}.',
  'train.rec.reason.inBandNoRir': '{reps} reps at {load}.',
  'train.rec.reason.bodyweightAdd': '{reps} reps at bodyweight — add a plate or a band.',
  'train.rec.reason.overBand': '{reps} reps — over the {lo}-{hi} band, under-loaded.',
  'train.rec.reason.belowBand': '{reps} reps last session; the band is {lo}-{hi}.',
  'train.rec.reason.belowBandCluster': 'C{group} gave {reps} reps last session; both clusters need {lo}-{hi}.',
  ...
  'train.rec.invalid.rirToFailure': 'Activation at RIR 0 — taken to failure.',
