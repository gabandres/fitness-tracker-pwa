...
export const en = {
  ...
  // ── onboarding ──
  'onboarding.titleNew': 'Welcome to Macronaut',
  ...
  'settings.inviteBody': 'Share Macronaut. When a friend signs up through your link, you both get a month of Pro free.',
  'settings.inviteShare': 'Share invite link',
  'settings.inviteShareMsg': 'Track calories + protein for free with Macronaut:',
  'settings.inviteRewardActive': 'Pro reward active until {date}',
  'settings.support': 'Support the app',
  'settings.supportBody': "Macronaut is free to track by hand. If the AI meal scans have been useful, a small tip helps cover the running cost — entirely optional, and it unlocks nothing.",
  ...
  'pro.badge': 'Pro',
  'pro.upsellSub': 'Unlock this and more with a one-time Macronaut Pro purchase.',
