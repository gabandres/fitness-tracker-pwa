...
| **ASC draft 1.2.3** | **`PREPARE_FOR_SUBMISSION`, created 2026-09-05 to hold the re-shot screenshots** (en-US 5, es-MX 5, replaced; `docs/app-store-metadata.md` §Screenshots). No build attached. The next iOS release goes out as 1.2.3 through this version; do not create another. |
