...
| **App Review** | build **55** (1.2.0), `WAITING_FOR_REVIEW` since 2026-08-15, **manual release**. Build 54 was swapped out the same day — it predated the verification-email fix | nothing — this is the submission |
