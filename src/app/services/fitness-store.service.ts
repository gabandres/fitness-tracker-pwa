...
export class FitnessStore {
  ...
  summaryFor(dateKey: string): {
    ...
    // `count` is the established public field name on this store
    // method; expose `mealCount` under that alias to keep existing
    // consumers (history-v2, day-summary card, etc.) unchanged.
    return {
