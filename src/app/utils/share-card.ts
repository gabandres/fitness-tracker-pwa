...
// The pure stat selection now lives in @macrolog/core (shared with the Expo
// app — see docs/adr/0012). This file keeps the web canvas render + Web-Share
// handoff and re-exports the pure bits so existing imports keep working.
export { shareStatItems, type ShareStats, type ShareStatItem } from '@macrolog/core';
