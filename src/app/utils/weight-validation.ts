/**
 * Bodyweight sanity rules — the one place the "is this a plausible weight"
 * question is answered, so the Body-tab logger, the workout-finish mirror,
 * and the store backstop all agree.
 *
