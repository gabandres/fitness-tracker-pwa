// Pure progression + PR math for the Train tab. No Angular, no React, no I/O —
// mirrors the day-summary pure-module convention so the rules are unit-testable
// in isolation (ADR-0003). Shared by both apps (ADR-0012).
