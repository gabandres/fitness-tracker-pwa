...
Macronaut — a free, private kcal+protein tracker (live at <https://macrolog.web.app>). The repo is an **npm-workspaces monorepo** with three buildable units plus shared code:
